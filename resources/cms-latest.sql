...
--
-- Host: localhost    Database: Nerdy_herhd
-- ------------------------------------------------------
-- Server version	10.11.5-MariaDB-1:10.11.5+maria~ubu2004
...
CREATE TABLE `pushUsers` (
  ...
  `p256dhKey` varchar(128) NOT NULL,
...
CREATE TABLE `video` (
  ...
  `free_member_view_price` decimal(10,2) DEFAULT NULL,
  `premium_member_view_price` decimal(10,2) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `wal_trans`
--

DROP TABLE IF EXISTS `wal_trans`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
-- Dump completed on 2024-05-12 23:17:59
