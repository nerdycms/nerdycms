...
if($idx < sizeof($list)) { $a = $list[$idx]; $vurl = $a?VDIR."video?_video=$a[seo_url]":VDIR; ?>

<div onclick="window.location.href='<?=$vurl?>'" class="preview model-scene"  style="<?=$ent->meta($a,"background")?>">               
    <div>
