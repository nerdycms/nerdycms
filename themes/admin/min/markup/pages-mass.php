                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">                                                                                                
                                <h4 class="card-title"><?=_l("mass messaging")?></h4>
                                <p class="card-title-desc"><?=_l("mass message help")?></p>
                            </div>                            
                                <div class="card-body p-4"><div class="row">                                     
                                    ...
                                    <div class="col-md-6">
                                        <div>
                                            <div class="mb-3">                                                
                                                <label for="target" class="form-label"><?=_l("template")?></label>                                                
                                                <select oninput="tplLoad(this.selectedIndex)" name="template" class="form-control" id="template">
                                                    <?php                                                         
                                                        $ent = new emTemplate(["where"=>"preset IS null"]);
                                                        $allTpl = $ent->fetch("array");
                                                        foreach($allTpl as $row) {
                                                            echo "<option value='$row[id]'>$row[email_subject]</option>";
                                                        }
                                                    ?>
                                                </select>
                                                <script>
                                                    var allTpl = <?=json_encode($allTpl)?>;
                                                </script>    
                                            </div>
                                        </div>
                                    </div>   
                                    <div class="col-md-12">
                                        <div>
                                            <div class="mb-3">                                                
                                                <label for="preview" class="form-label"><?=_l("template")?></label>      
                                                <div style="max-height: 32rem;overflow-y: auto" class="form-control" id="preview"></div>
                                            </div>
                                        </div>
                                    </div>    
                                </div>                                
